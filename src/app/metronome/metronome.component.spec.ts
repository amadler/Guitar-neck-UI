...
describe('MetronomeComponent', () => {
    ...
    let mockEngine: MockedObject<MetronomeEngineService>;
    ...
    describe('tapTempo', () => {
        ...
        it('should compute ~120 BPM from 6 taps at 500ms intervals', () => {
            ...
            let callIndex = 0;
            vi.spyOn(Date, 'now').mockImplementation(() => now + tapTimes[callIndex++]);
        ...
        it('should reset tap array if gap exceeds 2000ms', () => {
            ...
            vi.spyOn(Date, 'now').mockImplementation(() => now + timestamps[callIndex++]);
