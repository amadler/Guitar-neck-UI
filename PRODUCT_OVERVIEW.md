...
- **Show** — wyświetlanie skal muzycznych lub akordów 
- **Compare** — tryb Scale + Chord z niezależnym wyborem skali i akordu
  ...
  - Każda rola ma dedykowaną klasę CSS  — kolory interwałowe wyłączone w tym trybie
...
5. Nuty akordu spoza skali są widoczne na gryfie innym stylem (`chord-tone-outside-scale`)
...
## Integracje
- **Tonal.js** — lokalny silnik teorii muzyki (skale, akordy, interwały). 
...
- Integracja z tabulaturą

## Ograniczenia Techniczne
- AI Chat, wymaga klucza API . Jest podawany przez użytkownika i przechowywany w local storage.
